...
data in the database to text files found in IOReward_E2/ExpAssets/Data.
...
CREATE TABLE trials (
	...
	tilt_line_loc text not null,
	low_value_col text not null,
	flat_line_loc text not null,
	winning_trial text not null,
	line_response text not null,
	line_rt text not null,
